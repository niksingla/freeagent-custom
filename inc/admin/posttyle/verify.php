...
function jws_register_verify() {

	$labels = array(
		'name'                => _x( 'Verify', 'Post Type General Name', 'freeagent' ),
		'singular_name'       => _x( 'Verify', 'Post Type Singular Name', 'freeagent' ),
		'menu_name'           => esc_html__( 'Verify', 'freeagent' ),
		'parent_item_colon'   => esc_html__( 'Parent Item:', 'freeagent' ),
		'all_items'           => esc_html__( 'Verify', 'freeagent' ),
    ...
    if(function_exists('custom_reg_post_type')){
    	custom_reg_post_type( 'jws_verify', $args );
    }


};

add_action( 'init', 'jws_register_verify', 1 );