 ...
 * @since 1.0.0
 */
class Jws_Fancy_Heading extends Widget_Base {
	...
	public function get_icon() {
		return 'eicon-t-letter jws-element';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'subtitle',
			array(
				'label'       => esc_html__( 'Subtitle', 'freeagent' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => [
					'active' => true,
				],
			
				'placeholder' => esc_html__( 'Enter your title', 'freeagent' ),
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'raw' => sprintf( __( '<div style="font-style:normal">If you want to use highlighted text use shortcode. Example:<br/><br/> <span style="font-weight:bold">[jws_highlight]</span> Your Text <span style="font-weight:bold">[/jws_highlight]</span></div>', 'freeagent' ) ),
				'separator' => 'after',
		...
		$this->add_control(
			'tag',
			[
				'label' => esc_html__( 'Element Tag', 'freeagent' ),
		...
		$this->add_control(
			'color_hover',
			array(
				'label' => __( 'Hover color', 'freeagent' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'add_gradient',
			[
				'label' => __( 'Gradient And Mask Image?', 'freeagent' ),
		...
		$this->add_group_control(
			...
			[
				'name' => 'color2',
				'label' => __( 'Fancy Heading Background', 'freeagent' ),
		...
		$this->add_control(
			'use_inheritance',
			[
				'label' => __( 'Inherit font styles?', 'freeagent' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'freeagent' ),
				'label_off' => __( 'Off', 'freeagent' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'enable_split',
			[
				'label' => __( 'Enable text split?', 'freeagent' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'freeagent' ),
				'label_off' => __( 'Off', 'freeagent' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'split_type',
			[
				'label' => __( 'Splitting type', 'freeagent' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'lines',
				'options' => [
					'lines'  => __( 'Lines', 'freeagent' ),
					'words' => __( 'Words', 'freeagent' ),
					'chars, words' => __( 'Characters', 'freeagent' ),
				],
				'condition' => [
					'enable_split' => 'true',
				],
		...
		$this->add_control(
			'use_mask',
			[
				'label' => __( 'Enabled mask?', 'freeagent' ),
				'description' => __('Check to enable mask on title to use it in animation', 'freeagent'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'freeagent' ),
				'label_off' => __( 'Off', 'freeagent' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'enable_txt_rotator',
			[
				'label' => __( 'Enable text rotator?', 'freeagent' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'freeagent' ),
				'label_off' => __( 'Off', 'freeagent' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'rotator_type',
			[
				'label' => __( 'Animation type', 'freeagent' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => __( 'Slide', 'freeagent' ),
					'basic' => __( 'Basic', 'freeagent' ),
					'list' => __( 'List', 'freeagent' ),
				],
				'condition' => array(
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Visible words', 'freeagent' ),
				'description' => esc_html__( 'For best results, set an odd number if your words count is even, and vice versa.', 'freeagent' ),
		...
		$this->add_control(
			'rotator_delay', [
				'label' => __( 'Words stay time', 'freeagent' ),
				'description' => __( 'Stay time for each word in seconds. Default is 2 seconds', 'freeagent' ),
				'type' => Controls_Manager::TEXT,
				'condition' => array(
					'enable_txt_rotator' => 'yes',
				),
		...
		$this->add_control(
			'word_colors',
			[
				'label' => __( 'Words color', 'freeagent' ),
				'type' => Controls_Manager::COLOR,
				'condition' => array(
					'enable_txt_rotator' => 'yes',
				),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Active color start', 'freeagent' ),
				'type' => Controls_Manager::COLOR,
				'condition' => array(
					'enable_txt_rotator' => 'yes',
					'rotator_type' => 'list',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Active color stop', 'freeagent' ),
				'type' => Controls_Manager::COLOR,
				'condition' => array(
					'enable_txt_rotator' => 'yes',
					'rotator_type' => 'list',
		...
		$this->add_control(
			'items',
			[
				'label' => __( 'Text rotator words', 'freeagent' ),
		...
		$this->start_controls_section(
			'white_space_section',
			[
				'label' => __( 'White Space', 'freeagent' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'whitespace',
			[
				'label' => __( 'Whitespace', 'freeagent' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => __( 'Normal', 'freeagent' ),
					'ws-nowrap' => __( 'Nowrap', 'freeagent' ),
				]
			]
		);
		...
		$this->add_control(
			'highlight_type',
			[
				'label' => __( 'Type', 'freeagent' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'jws-highlight-underline',
				'options' => [
					''  => __( 'None', 'freeagent' ),
					'jws-highlight-underline'  => __( 'Background', 'freeagent' ),
					'jws-highlight-custom-underline' => __( 'Custom 1', 'freeagent' ),
					'jws-highlight-custom-underline jws-highlight-custom-underline-alt' => __( 'Custom 2', 'freeagent' ),
					'jws-highlight-custom jws-highlight-custom-3' => __( 'Custom 3', 'freeagent' ),
					'jws-highlight-custom jws-highlight-custom-4' => __( 'Custom 4', 'freeagent' ),
					'jws-highlight-custom jws-highlight-custom-5' => __( 'Custom 5', 'freeagent' ),
				],
			]
		);
		...
		$this->add_control(
			'highlight_animation',
			[
				'label' => __( 'Animation', 'freeagent' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'jws-highlight-grow-left',
				'options' => [
					'jws-highlight-grow-left'  => __( 'Grow From Left', 'freeagent' ),
					'jws-highlight-grow-bottom' => __( 'Grow From Bottom', 'freeagent' ),
					'jws-highlight-fadein' => __( 'Fade In', 'freeagent' ),
				],
				'condition' => array(
					'highlight_type' => 'jws-highlight-underline',
				),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Fill Text On Hover?', 'freeagent' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'freeagent' ),
				'label_off' => __( 'Off', 'freeagent' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Highlight Text Color', 'freeagent' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jws-highlight-txt' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			'highlight_color',
			[
				'label' => __( 'Highlight Color', 'freeagent' ),
				'type' => Controls_Manager::COLOR,
				'condition' => array(
					'highlight_type' => 'jws-highlight-underline',
				),
				'selectors' => [
					'{{WRAPPER}} .jws-highlight-inner' => 'background: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'condition' => [
					'highlight_type' => 'jws-highlight-custom-underline jws-highlight-custom-underline-alt',
				],
				'selectors' => [
					'{{WRAPPER}} .jws-highlight-inner .jws-highlight-brush-svg-2' => 'fill: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'condition' => array(
					'highlight_type' => [
						'jws-highlight-custom-underline',
						'jws-highlight-custom jws-highlight-custom-3',
						'jws-highlight-custom jws-highlight-custom-4',
						'jws-highlight-custom jws-highlight-custom-5',
					]
				),
				'selectors' => [
					'{{WRAPPER}} .jws-highlight-inner .jws-highlight-brush-svg path' => 'stroke: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			'highlight_width',
			[
				'label' => __( 'Width', 'freeagent' ),
				'type' => Controls_Manager::TEXT,
				'condition' => array(
					'highlight_type' => array(
						'jws-highlight-underline',
						'jws-highlight-custom-underline',
						'jws-highlight-custom jws-highlight-custom-3',
						'jws-highlight-custom jws-highlight-custom-4',
						'jws-highlight-custom jws-highlight-custom-5',
				...
				'selectors' => [
					'{{WRAPPER}} .jws-highlight-inner, {{WRAPPER}} .jws-highlight-inner .jws-highlight-brush-svg' => 'width: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jws-highlight-inner, {{WRAPPER}} .jws-highlight-inner .jws-highlight-brush-svg' => 'height: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			'highlight_offset',
			[
				'label' => __( 'Bottom Offset', 'freeagent' ),
				'type' => Controls_Manager::TEXT,
				'default' => '0em',
				'placeholder' => __( 'Add line bottom offset, for ex -10px', 'freeagent' ),
				'condition' => array(
					'highlight_type!' => '',
				),
				'selectors' => [
					'{{WRAPPER}} .jws-highlight-inner' => 'bottom: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Left Offset', 'freeagent' ),
				'type' => Controls_Manager::TEXT,
				'default' => '0em',
				'placeholder' => __( 'Add line left offset, for ex -10px', 'freeagent' ),
				'condition' => array(
					'highlight_type!' => '',
				),
				'selectors' => [
					'{{WRAPPER}} .jws-highlight-inner' => 'left: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			'highlight_roudness',
			[
				'label' => __( 'Roundness', 'freeagent' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Add line roudness in px, for ex 5px', 'freeagent' ),
				'condition' => array(
					'highlight_type' => 'jws-highlight-underline',
				),
				'selectors' => [
					'{{WRAPPER}} .jws-highlight-inner' => 'border-radius: {{VALUE}}',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			'hover_text_outline',
			[
				'label' => __( 'Outline Text', 'freeagent' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'freeagent' ),
				'label_off' => __( 'Off', 'freeagent' ),
		...
		$this->add_control(
			'outline_appearance',
			[
				'label' => __( 'Appearance', 'freeagent' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => __( 'None', 'freeagent' ),
					'ld-fh-outline-static' => __( 'Default', 'freeagent' ),
					'ld-fh-outline' => __( 'On Hover', 'freeagent' ),
				],
				'condition' => array(
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => '2px',
				'placeholder' => __( 'Set hover text outline width in px. for ex. 5px', 'freeagent' ),
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Vertical Text', 'freeagent' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_responsive_control(
			'subtitle_spacing',
			array(
				'label'       => esc_html__( 'Subtitle Spacing', 'freeagent' ),
				'description' => esc_html__( 'Controls the padding of your heading.', 'freeagent' ),
		...
		$this->add_responsive_control(
			'ld_inner_margin',
			[
				'label' => __( 'Heading Margin', 'freeagent' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'ld_inner_padding',
			[
				'label' => __( 'Heading Padding', 'freeagent' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '.elementor-element-{{ID}} .des',
			)
		);
            $this->add_control(
			'des_color',
			[
				...
				'default' 	=> '',
				'selectors' => [
					'.elementor-element-{{ID}} .des' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
			'des_spacing',
			array(
				'label'       => esc_html__( 'Description Spacing', 'freeagent' ),
				'description' => esc_html__( 'Controls the padding of your heading.', 'freeagent' ),
				'type'        => Controls_Manager::DIMENSIONS,
				'size_units'  => array(
					'px',
				...
				'selectors'   => array(
					'.elementor-element-{{ID}} .des' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}}.jws-active-row-light .ld-fh-element, {{WRAPPER}}.jws-active-row-light .ld-fh-element span, {{WRAPPER}}.jws-active-row-light .ld-fh-element a' => 'color:{{VALUE}} !important;',
				],
				'condition' => [
					'add_gradient' => ''
				]
		...
		$this->add_control(
			...
			array(
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}}.jws-active-row-dark .ld-fh-element, {{WRAPPER}}.jws-active-row-dark .ld-fh-element span, {{WRAPPER}}.jws-active-row-dark .ld-fh-element a' => 'color:{{VALUE}} !important;',
				],
				'condition' => [
					'add_gradient' => ''
				]
	...
	protected function add_render_attributes() {
		...
		if ( $settings['enable_split'] !== '' ) {
			array_push($classnames, 'jws-el-has-inner-anim');
		}
	...
	protected function render() {
       ...
       $description =  $settings['description'];
		...
		<div id="<?php echo esc_attr( $id ); ?>" class="<?php echo jws_sanitize_html_classes( $classes ); ?>">
        	<?php 
            if(!empty($subtitle)){
	...
	protected function content_template() {
		...
		if ( highlightType === 'jws-highlight-underline' ) {
			highlightClassname = 'jws-highlight-classic';
		} else if ( highlightType === 'jws-highlight-custom-underline' ) {
			highlightClassname = 'jws-highlight-custom jws-highlight-custom-1';
		} else if ( highlightType === 'jws-highlight-custom-underline jws-highlight-custom-underline-alt' ) {
			highlightClassname = 'jws-highlight-custom jws-highlight-custom-2';
		}
		...
		const titleClassnames = [
			...
			settings.highlight_reset_onhover === 'yes' ? 'jws-highlight-reset-onhover' : '',
		...
		function getAdvancedText() {
			...
			if ( items.length >= 1 ){
        items.forEach(item => {
            content += `<span class="jws-adv-txt-item elementor-repeater-item-${item._id}">`;
            if ( item.image?.url !== '' ){
							const render_image = {
								id: item.image.id,
								url: item.image.url,
							...
							const img_html = `<figure class="jws-adv-txt-fig pos-rel d-inline-flex"><img src="${render_image_url}" /></figure>`;
		...
		const getHighlightOpts = (() => {
			...
			if ( ! settings.content.includes("jws_highlight") ){
				return;
			}

			titleAttrs['data-inview'] = true;
			titleAttrs['data-transition-delay'] = true;
			titleAttrs['data-delay-options'] = JSON.stringify({ "elements": ".jws-highlight-inner", "delayType": "transition" });
		...
		#>
			<div {{{ view.getRenderAttributeString('wrapperAttributes') }}}>
				<{{{ settings.tag }}} {{{ view.getRenderAttributeString('titleAttributes') }}} >
					...
					<# } #>
					<# if ( content.includes("[jws_highlight]") && content.includes("[/jws_highlight]") ) {
						content = content.replace('[jws_highlight]', '<mark class="jws-highlight"><span class="jws-highlight-txt">');
						content = content.replace('[/jws_highlight]', '</span><span class="jws-highlight-inner">'+ getSVGHighlight() + '</span></mark>');
	...
	protected function fancy_title() {
		...
		if( !empty( $settings['highlight_type'] ) ) {
			...
			if ( $highlight_type === 'jws-highlight-underline' ) {
				$highlight_classname = 'jws-highlight-classic';
			} else if ( $highlight_type === 'jws-highlight-custom-underline' ) {
				$highlight_classname = 'jws-highlight-custom jws-highlight-custom-1';
			} else if ( $highlight_type === 'jws-highlight-custom-underline jws-highlight-custom-underline-alt' ) {
				$highlight_classname = 'jws-highlight-custom jws-highlight-custom-2';
			}
		...
		if( !empty( $settings['highlight_reset_onhover'] ) && $settings['highlight_reset_onhover'] === 'yes' ) {
			$classnames_arr[] = 'jws-highlight-reset-onhover';
		}
		...
		if( 'ld-fh-outline' === $settings['hover_text_outline'] ) {
			$outline_title = '<span class="ld-fh-txt-outline">' .  jws_do_the_content( $title, false ) . '</span>';
		}
		...
		if( $title ) {
			if ( !empty ( $link ) ) {
				...
				printf( '<%1$s %3$s %4$s><a%5$s %7$s'. $this->get_split_options() .'>%6$s %2$s</a></%1$s>', !empty( $tag ) ? $tag : 'h2', jws_do_the_content( $title, false ), $classnames, $this->get_data_opts(), esc_attr( $link ), $outline_title, $inline_edit_attr);
			}
			else {
				printf( '<%1$s %3$s %4$s %6$s'. $this->get_split_options() .'>%5$s %2$s</%1$s>', !empty( $tag ) ? $tag : 'h2', jws_do_the_content( $title, false ), $classnames, $this->get_data_opts(), $outline_title, $inline_edit_attr);
			}
	...
	protected function get_data_opts() {
		...
		return jws_html_attributes( $opts );
	...
	protected function get_highlight_opts() {
		...
		if( !has_shortcode( $settings['content'], 'jws_highlight' )  ) {
			return;
		}
