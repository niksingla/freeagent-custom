        ...
        <div class="jws_post_content">
                   ...
                   <?php if($settings['show_category']=='yes'):?>
                     ...
                     <?php  
                     	...
                     	foreach ( $terms as $term  ) {
                     	    $category_color = get_field('color', 'category_' . $term->term_id);
               ...
               <div class="meta_infor">
                <?php if($settings['show_date']=='yes'):?>
                   ...
                   <a  class="jws-post-author" href="<?php echo esc_url(get_author_posts_url( get_the_author_meta('ID') )); ?>"><span><?php echo esc_html__('By ','freeagent')?></span><?php echo get_the_author(); ?></a> 
                   <?php endif;?> 
               </div>
