 ...
 * @since 1.0.0
 */
class Jws_Button_Advanced extends Widget_Base {
	...
	public function get_title() {
		return __( 'jws Button', 'freeagent' );
	}
	...
	public function get_icon() {
		return 'eicon-button jws-element';
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'rotate_x',
			[
				'label' => __( 'Button Rotate', 'freeagent' ),
        ...
        $this->add_control(
			'rotate_x_icon',
			[
				'label' => __( 'Icon Rotate', 'freeagent' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
	...
	protected function render() {
		...
		$button = new \jws_Elementor_Render_Button;
