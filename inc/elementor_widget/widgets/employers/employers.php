 ...
 * @since 1.0.0
 */
class employers extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws employers', 'freeagent' );
	}
	...
	protected function register_content_general_controls() {
        ...
        $this->add_responsive_control(
				...
				[
                    ...
                    'selectors' => [
							'{{WRAPPER}} .jws-employers-wap' => 'text-align: {{VALUE}};',
        ...
        $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .jws-employers-element .jws-employers-wap' => 'background-color: {{VALUE}};',
				],
			]
		);
  ...
  $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .jws-employers-element .jws-employers-wap:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
  $this->add_group_control(
			...
			[
				...
				'selector'              => '{{WRAPPER}} .jws-employers-element .jws-employers-wap',
			]
		);
        ...
        $this->add_group_control(
            Group_Control_Border::get_type(),
                [
                    'name'      => 'box_border',
                    'selector'  => '{{WRAPPER}} .jws-employers-wap',
                ]
            );
        $this->add_responsive_control(
					'employers_padding',
					[
						...
						'size_units' 	=> [ 'px', 'em', '%' ],
						'selectors' 	=> [
							'{{WRAPPER}} .jws-employers-element .jws_employer_item  .jws-employers-wap' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
        ...
        $this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', 'em', '%' ],
						'selectors' 	=> [
							'{{WRAPPER}} .jws-employers-element .jws_employer_item  .jws-employers-wap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jws-employers-element .jws_employer_item ' => 'padding-right: calc( {{SIZE}}{{UNIT}}/2 ); padding-left: calc( {{SIZE}}{{UNIT}}/2 );',
					'{{WRAPPER}} .jws-employers-element .row' => 'margin-left: calc( -{{SIZE}}{{UNIT}}/2 ); margin-right: calc( -{{SIZE}}{{UNIT}}/2 );',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jws-employers-element .jws_employer_item ' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
            ...
            $this->add_control(
    			...
    			[
    				...
    				'selectors' => [
    					'{{WRAPPER}} .jws-employers-element .jws-employers-wap .entry-title a' => 'color: {{VALUE}}',
    				],
    			]
    	   );
        $this->add_control(
    			...
    			[
    				...
    				'type' => \Elementor\Controls_Manager::COLOR,
    				'selectors' => [
    					'{{WRAPPER}} .jws-employers-element .jws-employers-wap .entry-title a:hover' => 'color: {{VALUE}}',
    				],
    			]
    	   );
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jws-employers-element .jws-employers-wap .entry-title',
			]
		);
        $this->add_responsive_control(
			'spacing_title',
			[
				...
				'size_units' 	=> [ 'px', 'em', '%' ],
				'selectors' 	=> [
					'{{WRAPPER}} .jws-employers-element .jws-employers-wap  .entry-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
        ...
        $this->add_control(
    			...
    			[
    				...
    				'type' => \Elementor\Controls_Manager::COLOR,
    				'selectors' => [
    					'{{WRAPPER}} .jws-employers-element .jws-employers-wap .excerpt' => 'color: {{VALUE}}',
    				],
    			]
    	   );
        $this->add_control(
    			...
    			[
    				...
    				'type' => \Elementor\Controls_Manager::COLOR,
    				'selectors' => [
    					'{{WRAPPER}} .jws-employers-element .jws-employers-wap:hover .excerpt' => 'color: {{VALUE}}',
    				],
    			]
    	   );
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'freeagent' ),
				'selector' => '{{WRAPPER}} .jws-employers-element .jws-employers-wap .excerpt',
			]
		);
        $this->add_responsive_control(
			'ct_excerpt',
			[
				...
				'size_units' 	=> [ 'px', 'em', '%' ],
				'selectors' 	=> [
					'{{WRAPPER}} .jws-employers-element .jws-employers-wap .excerpt' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
        ...
        $this->add_responsive_control(
			'spacing_btn',
			[
				'label' 		=> esc_html__( 'Button Margin', 'freeagent' ),
				'type' 			=> Controls_Manager::DIMENSIONS,
				'size_units' 	=> [ 'px', 'em', '%' ],
				'selectors' 	=> [
					'{{WRAPPER}} .jws-employers-element .jws-employers-wap .btn_actions' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
  ...
  $this->add_group_control(
		...
		$this->add_control(
			...
			$this->add_control(
				...
				[
					...
					'multiple'  => true,
					'default'   => '',
					'options'   => $this->get_employers_categories(),
					'condition' => [
						'query_type' => 'custom',
					],
				]
			...
			$this->add_control(
				...
				[
					...
					'multiple'  => true,
					'default'   => '',
					'options'   => $this->get_employers_tags(),
					'condition' => [
						'query_type' => 'custom',
					],
				]
	...
	protected function register_content_slider_controls() {
	   jws_elementor_widget_slider_config($this,['employers_display' => 'slider']);
	}
        /**
	 ...
	 * @access protected
	 */
	protected function get_employers_categories() {
		...
		$employers_categories = get_terms( 'employers_cat', $cat_args );
        
        
		if ( ! empty( $employers_categories ) ) {

			foreach ( $employers_categories as $key => $category ) {

				$employers_cat[ $category->slug ] = $category->name;
			}
		}

		return $employers_cat;
	}
    /**
	 ...
	 * @access protected
	 */
	protected function get_employers_tags() {
		...
		$employers_tag = get_terms( 'employers_tag', $tag_args );
        
        $employers_tag = '';

		if ( ! empty( $employers_tag ) ) {

			foreach ( $employers_tag as $key => $tag ) {

				$employers_tag[ $tag->slug ] = $tag->name;
			}
		}

		return $employers_tag;
	}
	/**
	...
	protected function render() {
        ...
        $encoded_atts = json_encode( $settings );
		    ...
		    if ( $settings['employers_per_page'] > 0 ) {
					$query_args['posts_per_page'] = $settings['employers_per_page'];
			}
			...
			$query_args = apply_filters( 'jws_employers_query_args', $query_args, $settings );

			$employers = new \WP_Query( $query_args );
            
            
            
      $class_row = 'employers-content';  
      $class_row .= ' jws_employer_'.$settings['employers_layouts'].'';
      $class_row .= ' employers_ajax_'.$this->get_id().'';
      $class_column = 'jws_employer_item ';
      $show_dots = ( in_array( $settings['navigation'], [ 'dots', 'both' ] ) );
    	$show_arrows = ( in_array( $settings['navigation'], [ 'arrows', 'both' ] ) );
        $show_inbox = ($settings['show_inbox'] == 'yes') ? 'show_container' : '';
     
      
      if($settings['employers_display'] == 'slider') {
        
            $class_row .= ' swiper jws_employers_'.$settings['employers_display'].' '.$show_inbox;
            $class_column .= ' swiper-slide';
               
        }else{
          $class_row .= ' row jws-employers-'.$settings['employers_display']; 
          $class_column .= ' col-xl-'.$settings['employers_columns'].'';
          $class_column .= (!empty($settings['employers_columns_tablet'])) ? ' col-lg-'.$settings['employers_columns_tablet'].'' : ' col-lg-'.$settings['employers_columns'].'' ;
          $class_column .= (!empty($settings['employers_columns_mobile'])) ? ' col-'.$settings['employers_columns_mobile'].'' :  ' col-'.$settings['employers_columns'].'';  
        }
      ?>
 
		
		<div class="jws-employers-element">
            <div class="<?php echo esc_attr($class_row);?>" >
            <?php if($settings['employers_display'] == 'slider') echo '<div class="swiper-wrapper">';?>
                <?php 
                        ...
                        $i =0;
                            while ( $employers->have_posts() ) :
                                    ...
                                    echo '<div class="'.$class_column.'">';
                                           ...
                                           include( 'layout/'.$settings['employers_layouts'].'.php' );
                ...
                ?>
                <?php if($settings['employers_display'] == 'slider') echo '</div>';?>  
                <?php 
                    if($show_arrows && $settings['employers_display'] == 'slider') : ?>
                  ...
                  <?php endif;
                if($show_dots && $settings['employers_display'] == 'slider'){
            ...
            <?php 
             global $wp_query;
             $number_page = $employers->max_num_pages;
             $pagi_number = jws_query_pagination($employers);
            if ( $number_page > 1 && $settings['pagination_type'] == 'load_more' ) {
                 wp_enqueue_script( 'isotope');
                  wp_enqueue_script( 'imageload'); 
                 $load_attr = 'data-ajaxify-options=\'{"wrapper":".employers_ajax_'.$this->get_id().'","items":"> .jws_employer_item ","trigger":"click"}\''; 
                  $paged = $employers->get('paged') ? $employers->get('paged') : 1;
