...
<form method="get" action="<?php echo esc_url( $form_action ); ?>">
	<div class="price_slider_wrapper">
		...
		<div class="price_slider_amount" data-step="<?php echo esc_attr( $step ); ?>">
			<input type="text" id="min_price" name="min_price" value="<?php echo esc_attr( $current_min_price ); ?>" data-min="<?php echo esc_attr( $min_price ); ?>" placeholder="<?php echo esc_attr__( 'Min price', 'freeagent' ); ?>" />
			<input type="text" id="max_price" name="max_price" value="<?php echo esc_attr( $current_max_price ); ?>" data-max="<?php echo esc_attr( $max_price ); ?>" placeholder="<?php echo esc_attr__( 'Max price', 'freeagent' ); ?>" />
			<?php /* translators: Filter: verb "to filter" */ ?>
			<div class="price_label" style="display:none;">
				<?php echo esc_html__( 'Price:', 'freeagent' ); ?> <span class="from"></span> &mdash; <span class="to"></span>
			</div>
