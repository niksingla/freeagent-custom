...
<?php if ( $product->is_in_stock() ) : ?>
	...
	<form class="cart yith-wcpb-bundle-form" method="post" enctype='multipart/form-data'
		...
		<?php
		$add_to_cart_button = '<button type="submit" data-product_id="'.esc_attr($product->get_id()).'" class="single_add_to_cart_button button alt yith-wcpb-add-to-cart-button"><span>' . esc_html( $product->single_add_to_cart_text() ) . '</span></button>';
