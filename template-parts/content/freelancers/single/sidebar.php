...
<div class="box_left">
    <div class="author_wap">
            ...
            <p class="position"><?php echo ''.$freelancers_position;?></p>
            <h1 class="title"><?php echo get_the_title();?></h1>
            <p class="member"><?php echo  esc_html__('Member since ','freeagent').get_the_date();?></p>
             <div class="location">
               <?php  
                if(!empty($location)){
            ...
            <?php freelancer_rating($post_id);?>
             <div class="more_detail chart">
                <ul>
                    <li>
                        <label class="label"><?php echo esc_html__('Jobs Completed','freeagent')?></label>
                        <p class="result completed"><?php echo ''.$percentage_completed;?>%</p>
                    </li>
                     <?php $freelancers_language = get_the_terms( $post_id, 'freelancers_language'); 
                      if ($freelancers_language && !is_wp_error($freelancers_language)) {?>
                      <li>
                        <label class="label"><?php echo esc_html__('Language:','freeagent')?></label>
                        <p class="language">
                       <?php
                        
                            $counter = 0;
                            $terms_count = count($freelancers_language);
                                 $listings_link = get_post_type_archive_link('freelancers').'?freelancers_language';
                                foreach ($freelancers_language as $term) {
                                   $counter++;
           ...
           ?>
           <a type="button" data-freelancer_id="<?php echo ''.$post_id;?>" data-modal-jws="#submit-hiring" href="javascript:void(0);" class="elementor-button btn_contact"><?php echo esc_html__('Contact Me','freeagent');?></a>
          <div class="d-flex fl-center al-center">  
              <?php jws_button_freelancer_save( $post_id );?>
                <a href="javascript:void(0);" class="btn_message" data-modal-jws="#create-chat"><i class="jws-icon-chat"></i>  </a>
           </div>
       ...
       <?php if($active_profile == '1') { ?>
        <form>   
            ...
            <div class="form-group">
                <label  class="fw-700 d-block"><?php echo esc_html__('What\'s the Message about?','freeagent')?></label>
            ...
            <div id="hiring-1" class="form-group hiring-type-field">
                ...
                <input name="job_new" placeholder="<?php echo esc_html__('What you need to get done','freeagent');?>"/>
            </div>
            <div class="form-group">
                <label for="message" class="fw-700 d-block"><?php echo esc_html__('Send a private message','freeagent')?></label>
                <textarea id="message" name="message" rows="4" placeholder="<?php echo esc_html__('Describe what you need in more detail...','freeagent');?>" required=""></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="note"><?php echo esc_html__('By clicking Send Invitation, you have read and agreed to our Terms & Conditions and Privacy Policy','freeagent')?></div>
                 <div class="form-button al-center">
                      ...
                      <button class="form-submit-btn hiring-submit elementor-button" type="button"><?php echo esc_html__('Send Invitation','freeagent'); ?></button>  
                  </div>
        </div>
