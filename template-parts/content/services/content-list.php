...
<div class="jws-services-inner"> 
    ...
    <div class="jws-service-content">
       <h6 class="entry-title"><a class="title" href="<?php echo get_permalink(); ?>"><?php  echo wp_trim_words( get_the_title(),12, '...' );?></a></a><?php  jws_button_service_save( get_the_ID() );?></h6> 
        ...
        <div class="jws_excerpt"><?php echo get_the_excerpt();?></div>
        <div class="sale_info">
